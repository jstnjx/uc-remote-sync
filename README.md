...
```text
remote-sync-0.7.5.tar.gz
remote-sync-0.7.5.tar.gz.sha256
```
...
2. Select `remote-sync-0.7.5.tar.gz`.
...
```bash
REMOTE_SYNC_IMAGE=ghcr.io/jstnjx/uc-remote-sync:0.7.5 docker compose up -d
```
